...
mesh_t mesh_build(unsigned int *obj_buffer, int *lengths)
{
    ...
    obj_buffer[0] = (unsigned int)malloc(lengths[0] * sizeof(float));
    obj_buffer[1] = (unsigned int)malloc(lengths[1] * sizeof(float));
    obj_buffer[2] = (unsigned int)malloc(lengths[2] * sizeof(float));
